...
def handle_voice_message(message: Dict[str, Any], chat_id: int) -> None:
    try:
        ...
        # Example: Set language_code based on user preference or message content
        language_code = 'en-US'  # Default to English, modify as needed
        transcription = audio_transcriber.transcribe_audio(file_url, language_code=language_code)
